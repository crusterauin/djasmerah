...
');
$belanda->setNamaMateri('Kolonialisme Belanda');
...
$pemuda->setGambar('');
$pemuda->setMateri('Pada tahun 1926, Indonesia menjadi saksi dari sebuah peristiwa yang sangat penting dalam sejarahnya. Ini adalah kisah tentang perjuangan dan semangat pemuda-pemuda Indonesia dalam mencapai kemerdekaan.<br><br>
...
');
$pemuda->setNamaMateri('Konggres Pemuda');
...
$pemuda->setJawabanBenar(
    'Untuk memperkuat persatuan pemuda Indonesia dan menumbuhkan kesadaran nasional.',
    'Kongres Pemuda 1 pada tahun 1926, dan Kongres Pemuda 2 pada tahun 1928',
    'Kongres Pemuda 1 dan 2 diadakan di Jakarta',
);

$pemuda->setJawabanSalah1(
    'Untuk memperjuangkan perdamaian antara belanda dan Indonesia',
    'Untuk mempromosikan kesetaraan gender',
    'Untuk mendukung perdamaian dunia',
    
);
$pemuda->setJawabanSalah2(
    'Kongres Pemuda 1 pada tahun 1945, dan Kongres Pemuda 2 pada tahun 1949',
    'Kongres Pemuda 1 dan 2 diadakan bersamaan pada tahun 1945',
    'Kongres Pemuda 1 dan 2 diadakan bersamaan pada tahun 1928',
);
$pemuda->setJawabanSalah3(
    'Kongres Pemuda 1 di Jakarta, dan Kongres Pemuda 2 di Surabaya',
    'Kongres Pemuda 1 dan 2 diadakan di Yogyakarta',
    'Kongres Pemuda 1 di Bandung, dan Kongres Pemuda 2 di Medan',
...
');
$jepang->setNamaMateri('Kolonialisme Jepang');
...
');
$rengasdengklok->setNamaMateri('Peristiwa Rengasdengklok');
...
$proklamasi->setMateri('Tahun 1945 adalah saksi bagi momen bersejarah dalam sejarah Indonesia. Di tengah kekuasaan Jepang yang masih mencengkram, semangat kemerdekaan yang menggebu di dalam hati rakyat tidak bisa dipadamkan.<br><br>
...
');
$proklamasi->setNamaMateri('Proklamasi');
...
$konflik98->setGambar('');
$konflik98->setMateri('Pada tahun 1998, terjadi lagi peristiwa yang tidak bisa dipisahkan dari Sejarah Indonesia, sebuah konflik besar yang dikenal dengan sebutan Konflik 1998. Konflik ini adalah serangkaian kerusuhan dan demonstrasi yang dimulai karena krisis ekonomi yang melanda Indonesia.<br><br>
...
');
$konflik98->setNamaMateri('Konflik 1998');
